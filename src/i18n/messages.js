...
export const messages = {
    ...
    [LOCALES.SAKHA]: {
        ...
        have_malignancy_lung_survey: '5. Раак искэнэ Эйиэхэ баар дуо?',
        answer5_yes_lung_survey: 'Баар',
        answer5_no_lung_survey: 'Суох',
        had_temperature_lung_survey: '6. Бүтэһик 10 хонук иһигэр температуураҥ 37,5 кыраадыстан үрдүктүк тахса сылдьыбыттаах дуо?',
